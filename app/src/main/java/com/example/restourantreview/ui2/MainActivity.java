...
import com.example.restourantreview.response.CustomerReviewsItem;
import com.example.restourantreview.response.PostReviewResponse;
import com.example.restourantreview.response.Restaurant;
import com.example.restourantreview.response.RestaurantResponse;
import com.example.restourantreview.retrofit.APIConfig;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void postReview(String review) {
        showLoading(true);
        Call<PostReviewResponse> client = APIConfig.getApiService().postReview(RESTAURANT_ID, "Dwi Septian", review);
